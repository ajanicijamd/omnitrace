...
if(NOT EXISTS "${OMNITRACE_PAPI_INSTALL_DIR}")
    ...
    execute_process(COMMAND ${CMAKE_COMMAND} -E make_directory
                            ${OMNITRACE_PAPI_INSTALL_DIR}/${CMAKE_DEFAULT_INSTALL_LIBDIR})
    execute_process(
        COMMAND
            ${CMAKE_COMMAND} -E touch ${OMNITRACE_PAPI_INSTALL_DIR}/${CMAKE_DEFAULT_INSTALL_LIBDIR}/libpapi.a
            ${OMNITRACE_PAPI_INSTALL_DIR}/${CMAKE_DEFAULT_INSTALL_LIBDIR}/libpfm.a
            ${OMNITRACE_PAPI_INSTALL_DIR}/${CMAKE_DEFAULT_INSTALL_LIBDIR}/libpfm.so)
    set(_OMNITRACE_PAPI_BUILD_BYPRODUCTS
        ${OMNITRACE_PAPI_INSTALL_DIR}/${CMAKE_DEFAULT_INSTALL_LIBDIR}/libpapi.a
        ${OMNITRACE_PAPI_INSTALL_DIR}/${CMAKE_DEFAULT_INSTALL_LIBDIR}/libpfm.a
        ${OMNITRACE_PAPI_INSTALL_DIR}/${CMAKE_DEFAULT_INSTALL_LIBDIR}/libpfm.so)
endif()
...
add_custom_target(
    ...
    COMMAND ${CMAKE_COMMAND} -E rm -rf ${OMNITRACE_PAPI_INSTALL_DIR}/${CMAKE_DEFAULT_INSTALL_LIBDIR}/*
    COMMAND
        ${CMAKE_COMMAND} -E touch ${OMNITRACE_PAPI_INSTALL_DIR}/${CMAKE_DEFAULT_INSTALL_LIBDIR}/libpapi.a
        ${OMNITRACE_PAPI_INSTALL_DIR}/${CMAKE_DEFAULT_INSTALL_LIBDIR}/libpfm.a
        ${OMNITRACE_PAPI_INSTALL_DIR}/${CMAKE_DEFAULT_INSTALL_LIBDIR}/libpfm.so
...
install(
    DIRECTORY ${OMNITRACE_PAPI_INSTALL_DIR}/${CMAKE_DEFAULT_INSTALL_LIBDIR}/
